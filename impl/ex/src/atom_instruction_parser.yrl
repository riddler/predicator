...
Terminals lit load compare listcompare endcompare bang between 'or' '[' ']' ',' 'and'. 
...
predicate -> variable listcompare array : ['$1', [array, '$3'], unwrap('$2')].
...
unwrap({listcompare,_,V}) -> [compare, V];
